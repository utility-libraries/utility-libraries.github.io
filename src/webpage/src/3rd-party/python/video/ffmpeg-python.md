...
- [package: https://pypi.org/project/ffmpeg-python/](https://pypi.org/project/ffmpeg-python/)
- ~~docs~~ <small>(see source)</small>
- [source: https://github.com/kkroening/ffmpeg-python](https://github.com/kkroening/ffmpeg-python)
