...
- [package: https://pypi.org/project/better-exceptions/](https://pypi.org/project/better-exceptions/)
- ~~docs~~ <small>(see source)</small>
- [source: https://github.com/Qix-/better-exceptions](https://github.com/Qix-/better-exceptions)
