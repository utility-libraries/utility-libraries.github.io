...
- [package: https://www.npmjs.com/package/zod/](https://www.npmjs.com/package/zod/)
...
<p align="center">
  <img src="https://github.com/colinhacks/zod/raw/master/logo.svg" width="200px" align="center" alt="Zod logo" />
...
Normally refinements always create issues with a `ZodIssueCode.custom` error code, but with `superRefine` it's possible to throw issues of any `ZodIssueCode`. Each issue code is described in detail in the Error Handling guide: [ERROR_HANDLING.md](https://github.com/colinhacks/zod/blob/master/ERROR_HANDLING.md).
...
> For detailed information about the possible error codes and how to customize error messages, check out the dedicated error handling guide: [ERROR_HANDLING.md](https://github.com/colinhacks/zod/blob/master/ERROR_HANDLING.md)
